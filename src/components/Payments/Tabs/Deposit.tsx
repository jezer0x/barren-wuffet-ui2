    ...
    return (
        <div className="mt-[23px]">
            <div className="flex select-none mb-[9px]">
                <Subtab title="Deposit" isActive={subtab === 0} setIsActive={() => setSubtab(0)} />
                <Subtab title="Stake" isActive={subtab === 1} setIsActive={() => setSubtab(1)} />
                <Subtab title="Deposit & Stake" isActive={subtab === 2} setIsActive={() => setSubtab(2)} />
            </div>
                        ...
                        return (
                            <div className="select-none">
                                ...
                                <div className="flex justify-between mt-[24px]">
                                    <span className="font-ubuntu text-white font-normal text-[14px]">Min. Curve steth LP Tokens</span>
                                    <span className="font-ubuntu text-white text-[14px] w-[35px]">-</span>
                                </div>
                                <div className="flex justify-between mt-[8px] mb-[24px]">
                                    <span className="font-ubuntu text-white font-normal text-[14px]">Slippage</span>
                                    <span className="font-ubuntu text-white text-[14px] w-[35px]">- %</span>
                                </div>
